...
app.use("/api/finance-calculator", require("./routes/financeCalculator"));
...
app.get("/qr-generator", (req, res) => sendNoCacheFile(res, path.join(__dirname, "public", "qr-generator.html")));
app.get("/qr-shop/:token", (req, res) => sendNoCacheFile(res, path.join(__dirname, "public", "qr-shop.html")));
